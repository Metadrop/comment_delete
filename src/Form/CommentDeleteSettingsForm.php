...
class CommentDeleteSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['comment_delete_default'] = [
      '#type' => 'radios',
      '#title' => $this->t('Default Delete Option'),
      '#description' => $this->t('Choose the default option selected when a comments deleted.'),
      '#options' => [
        0 => $this->t('Delete comment and replies'),
        1 => $this->t('Delete comment and move replies up'),
        2 => $this->t('Delete comment and keep replies'),
      ],
      '#required' => TRUE,
    ...
    $form['comment_delete_soft'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Soft delete comments'),
      '#description' => $this->t('When enabled the comment subject+body is cleared but comment+author is retained.'),
      '#default_value' => $config->get('soft'),
    ];
    $form['comment_delete_threshold'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Threshold Period'),
      '#description' => $this->t('Max allowable time comments can be deleted after creation. Enter zero (0) to disable.'),
      '#size' => 10,
    ...
    $form['comment_delete_message'] = [
      ...
      '#description' => $this->t('Customize confirmation message shown after comment has been deleted.'),
